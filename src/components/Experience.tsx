  ...
  const education = [
    {
      ...
      period: '2023 - 2025',
      description: 'I am currently pursuing my Masters in Computer Application with specialization in AI/ML with a CGPA of 6.95, focusing on advanced concepts in computer science, artificial intelligence, and machine learning, demonstrating my dedication to mastering these dynamic fields.',
      logo: '🎓',
    },
    {
      id: 2,
